        ...
        <div class="col-sm-6 col-xl-3">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body d-flex align-items-center gap-3">
                    ...
                    <div>
                        <div class="fs-4 fw-bold"><?= $statistics->total_tasks ?></div>
        ...
        <div class="col-sm-6 col-xl-3">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body d-flex align-items-center gap-3">
                    ...
                    <div>
                        <div class="fs-4 fw-bold"><?= $statistics->completed_tasks ?></div>
        ...
        <div class="col-sm-6 col-xl-3">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body d-flex align-items-center gap-3">
                    ...
                    <div>
                        <div class="fs-4 fw-bold"><?= $statistics->in_progress_tasks ?></div>
        ...
        <div class="col-sm-6 col-xl-3">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body d-flex align-items-center gap-3">
                    ...
                    <div>
                        <div class="fs-4 fw-bold"><?= $statistics->overdue_tasks ?></div>
