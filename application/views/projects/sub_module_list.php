...
<div class="container py-4">
    ...
    <div class="card border-0 shadow-sm">
            <div class="title my-3 mx-5 d-flex justify-content-between">
                <h4><?= $title ?></h4>
                <a class="btn btn-primary" href="<?= base_url('add_sub_module');?>">Add Sub Module</a>
            </div>
...
$(document).ready(function () {
    ...
    $('#example').DataTable({
        ...
        ajax: {
            url: "<?= base_url('admin/Ajax_controller/get_sub_module_list_ajx'); ?>",
            type: "POST",
            // dataSrc: ""
        },
        columns: [
